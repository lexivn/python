...
![step 1](./Achievement%201/Exercise%201.5/Step1.png)
...
![step 2](./Achievement%201/Exercise%201.5/Step2.png)
...
![step 3](./Achievement%201/Exercise%201.5/Step3.png)

## Create a Tea Object

In the main code, make an object under the main Recipe class for Tea

![step 4](./Achievement%201/Exercise%201.5/Step4.png)

## Create More Recipes

Create Coffee, Cake, and Banana Smoothie recipes.

![step 5](./Achievement%201/Exercise%201.5/Step5.png)

## Create Recipes List

Wrap the recipes into a list called `recipes_list`.

![step 6](./Achievement%201/Exercise%201.5/Step6.png)

## Search for Recipes

Use the `recipe_search()` method to search for recipes that contain each ingredient out of: Water, Sugar, Bananas.

![step 7](./Achievement%201/Exercise%201.5/Step7.png)

## Run the Script

Run “recipe_oop.py” and take screenshots of its execution.

![step 8 part 1](./Achievement%201/Exercise%201.5/Step8P1.png)
![step 8 part 2](./Achievement%201/Exercise%201.5/Step8P2.png)
...
![step 1](./Achievement%201/Exercise%201.6/P1Step1.png)
...
![step 2](./Achievement%201/Exercise%201.6/P1Step2.png)

## Create a Cursor

Initialize a cursor object from conn.

![step 3](./Achievement%201/Exercise%201.6/P1Step3.png)

## Create a Database

Create a database called **task_database**

![step 4](./Achievement%201/Exercise%201.6/P1Step4.png)

## Use the Database

Have your script access your database with the `USE` statement.

![step 5](./Achievement%201/Exercise%201.6/P1Step5.png)
...
![step 6](./Achievement%201/Exercise%201.6/P1Step6.png)
...
![step 1](./Achievement%201/Exercise%201.6/P2Step1.png)
...
![step 1](./Achievement%201/Exercise%201.6/P3Step1.png)
...
![step 2](./Achievement%201/Exercise%201.6/P3Step2.png)
...
![step 3](./Achievement%201/Exercise%201.6/P3Step3.png)
...
![step 1](./Achievement%201/Exercise%201.6/P4Step1.png)
...
![step 2](../Achievement%201/Exercise%201.6/P4Step2.png)
...
![step 3](./Achievement%201/Exercise%201.6/P4Step3.png)
...
![step 4](./Achievement%201/Exercise%201.6/P4Step4.png)
...
![step 3](./Achievement%201/Exercise%201.6/P5Step3.png)

## Execute Queries and Commit Changes

Execute this query and commit your changes to the table.

![step 4](./Achievement%201/Exercise%201.6/P5Step4.png)
...
![step 1](./Achievement%201/Exercise%201.6/P6Step1.png)

## Build Query

Build a query using the DELETE statement, where the row to be deleted is identified by the id that the user had specified.

![step 2](./Achievement%201/Exercise%201.6/P6Step2.png)

## Execute Query and Commit Changes

Execute Query and Commit Changes

![step 3](./Achievement%201/Exercise%201.6/P6Step3.png)
...
![step 1](./Achievement%201/Exercise%201.6/P7Step1.png)

## Add Recipes

Create about 3 to 4 simple recipes of your choice using the first option in your menu.

![step 2](./Achievement%201/Exercise%201.6/P7Step2.png)
...
![step 3](./Achievement%201/Exercise%201.6/P7Step3.png)

## Update a Recipe

Change a few values in some of your recipes using the third option in your script’s menu: Update a Recipe.

![step 4](./Achievement%201/Exercise%201.6/P7Step4.png)

## Delete a Recipe

Delete a Recipe

![step 5](./Achievement%201/Exercise%201.6/P7Step5.png)

## Exit

Exit the Script
![step 6](./Achievement%201/Exercise%201.6/P7Step6.png)
...
![step 1](./Achievement%201/Exercise%201.7/P2Step1.jpg)

## Set the Table Name

Define an attribute to set the table’s name as **final_recipes**.

![step 2](./Achievement%201/Exercise%201.7/P2Step2.jpg)
...
![step 6](./Achievement%201/Exercise%201.7/P2Step6.jpg)
...
![step 7](./Achievement%201/Exercise%201.7/P2Step7.jpg)

## Create the Table

Create the table on the database using the `create_all()` method from `Base.metadata`.

![step 8](./Achievement%201/Exercise%201.7/P2Step8.jpg)
...
![step 1](./Achievement%201/Exercise%201.7/P3Step1.jpg)

## View All Recipes Function

Function 2: view_all_recipes()

![step 2](./Achievement%201/Exercise%201.7/P3Step2.jpg)

## Search By Ingredient Function

Function 3: search_by_ingredients()

![step 3](./Achievement%201/Exercise%201.7/P3Step3.jpg)

## Edit Recipe Function

Function 4: edit_recipe()

![step 4](./Achievement%201/Exercise%201.7/P3Step4.jpg)

## Delete Recipe Function

Function 5: delete_recipe()

![step 5](./Achievement%201/Exercise%201.7/P3Step5.jpg)
...
![step 1](./Achievement%201/Exercise%201.7/P4Step1.jpg)
...
![step 1](./Achievement%201/Exercise%201.7/P5Step1.jpg)

## View All Recipes

View all recipes using the app.

![step 2](./Achievement%201/Exercise%201.7/P5Step2.jpg)

## Search By Ingredients

Search for recipes by ingredients using the app.

![step 3](./Achievement%201/Exercise%201.7/P5Step3.jpg)

## Edit a Recipe

Edit a recipe using the app.

![step 4](./Achievement%201/Exercise%201.7/P5Step4.jpg)

## Delete a Recipe

Delete a recipe using the app

![step 5](./Achievement%201/Exercise%201.7/P5Step5.jpg)

## Exit the Application

Exit the application through the main menu

![step 6](./Achievement%201/Exercise%201.7/P5Step6.jpg)
